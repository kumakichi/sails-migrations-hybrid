...
ColumnCompiler.prototype.varbinary = function(length) {
  //return 'varbinary(' + this._num(length, 8) + ')';
  return 'varchar(' + this._num(length, 8) + ') binary'; // ali hybrid style
};
ColumnCompiler.prototype.longblob = 'longtext binary';
